...
function CoachDashboard() {
  ...
  const primerNombre = (usuario.full_name || "Coach").split(" ")[0];
        ...
        <aside className="sidebar" id="sidebar">
          <ul className="nav flex-column">
            <li className="nav-item">
              <Link className="nav-link active" to="/coach/dashboard">
            ...
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-calendar-week"></i> Mis Clases
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-people"></i> Mis Alumnos
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="#">
                <i className="bi bi-clipboard-data"></i> Reportes
              </a>
            </li>
        ...
        <main className="main-content">
          <div className="mb-4">
            <h1 className="h3 mb-1">
              <i className="bi bi-house-door text-primary"></i> Hola Coach{" "}
              {nombreCapitalizado}
            </h1>
            <p className="text-muted mb-0">
              Panel de control de tu actividad como entrenador
            </p>
          </div>
              ...
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-start">
                    <div>
                      <p className="text-muted small mb-1">Alumnos activos</p>
            ...
            <div className="col-sm-6 col-lg-3">
              <div className="card border-0 shadow-sm h-100">
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-start">
                    <div>
                      <p className="text-muted small mb-1">Valoración</p>
